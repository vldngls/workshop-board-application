...
Write-Host "   - DEPLOYMENT.md for detailed instructions" -ForegroundColor White
Write-Host "   - WORKFLOW_DOCUMENTATION.md for feature details" -ForegroundColor White

Write-Host ""
Write-Host "🆘 Need help? Check the troubleshooting section in DEPLOYMENT.md" -ForegroundColor Yellow
